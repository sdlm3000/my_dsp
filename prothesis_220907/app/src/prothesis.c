...
int valve_pwm_middle_zhi = MIN_SPEED;   // 被动状态下，用于控制阀的PWM值
int valve_pwm_middle_bei = MIN_SPEED;   // 被动状态下，用于控制阀的PWM值
int valve_pwm_push = MAX_SPEED;         // 蹬腿状态下，用于控制阀的PWM值
...
float P_MAX = 16.5;         // 高压区油液压力的最大值
float P_HIGH = 14.0;        // 假肢蓄能最大的标志位
int CONTROL_FLAG = 0;       // 假肢控制输出的标志位

int MIN_VALVE_2 = 1999;
int MAX_VALVE_3 = 1200;
int MAX_VALVE_4 = 400;
