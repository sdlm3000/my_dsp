...
// Checkin $Date: 2011.5.25$
//###########################################################################
//
// FILE:  DSP2833x_Application.h
//
// TITLE:  对主程序中调用的源程序的包含和基本全局（主要是宏定义的变量）的宏定义，相应的函数的声明.
//
//###########################################################################
...
#ifndef DSP2833x_Application_H
#define DSP2833x_Application_H
...
-----------------------------------------------------------------------------*/
#if DSP28_28332                   // DSP28_28332 device only，DSP28_28332CPU默认的宏定义
...
#include "DSP2833x_GlobalPrototypes.h"         // Prototypes for global functions within the.c files.
#include "DSP2833x_GlobalVariableDefs.h"  	   //Global VariableDefs  within the .c files
...
//将中断的默认的入口函数，包含于外设的头文件中，主要实现对中断入口程序的初始化功能；
//将默认中断的函数声明放在28335的外设头文件中；
...
//延时函数的宏定义；可以调用全局函数DSP28x_usDelay实现延时命令；
