...
#define MOTION_DRIVER_TARGET_MSP430		//定义驱动部分,采用MSP430的驱动(移植到DSP28335)
...
//}
#define log_i 	uart_printf	//打印信息
#define log_e  	uart_printf	//打印信息
...
//返回值:0,正常
//    其他,失败
Uint8 mpu_dmp_get_data(float *pitch,float *roll,float *yaw, short *gyrox, short *accx)
{
